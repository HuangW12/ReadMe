 ...
 */
@WebServlet("/sellmessage")
public class sellmessage extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getSession().setAttribute(Constants.SELL_SESSION,sell);
		request.getSession().setAttribute(Constants.BOOK_SESSION,book);
		request.getSession().setAttribute(Constants.BTYPE_SESSION,type);
		
		request.getRequestDispatcher("/getSellCommeentlist").forward(request, response);
